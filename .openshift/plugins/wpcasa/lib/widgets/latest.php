...
add_action( 'widgets_init', 'wpsight_register_widget_latest' );
 
function wpsight_register_widget_latest() {

	register_widget( 'wpSight_Latest' );

}

class wpSight_Latest extends WP_Widget {
 
	function __construct() {
		$widget_ops = array( 'description' => __( 'Latest posts teaser', 'wpsight' ) );
		parent::__construct( 'wpSight_Latest', ':: ' . WPSIGHT_NAME . ' ' . __( 'Latest Posts', 'wpsight' ), $widget_ops );
    }
