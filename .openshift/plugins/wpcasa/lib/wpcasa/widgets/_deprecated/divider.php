...
add_action( 'widgets_init', 'wpcasa_register_widget_divider' );
 
function wpcasa_register_widget_divider() {
	register_widget( 'wpCasa_Divider' );
}

class wpCasa_Divider extends WP_Widget {
 
	function __construct() {
		$widget_ops = array( 'description' => __( 'Visual divider between widgets', 'wpsight' ) );
		parent::__construct( 'wpCasa_Divider', WPSIGHT_NAME . ' ' . __( 'Divider', 'wpsight' ), $widget_ops );
    }
