					...
					<div style="width:90%; margin: 0 5%;">
						...
						<div style="padding:50px; padding-top:40px; background-color:#FFFFFF; border:1px solid #DDDDDD; font-size: 14px;">
							...
							<table border="0" width="100%">
								...
								<tr>
									<td style="text-transform:uppercase; vertical-align:bottom; border-bottom: 1px solid #dddddd;" colspan="2">
								...
								foreach( $contact_fields as $field => $v ) {
									...
									if( empty( $v['id'] ) || ( $v['type'] == 'hidden' && $v['placeholder'] == false ) )
										continue; ?>
								...
								<tr>
									<td style="width: 25%; color: #333; font-size: 14px;"><strong><?php _e( 'Listing', 'wpsight' ); ?>:</strong></td>
									<td style="width: 75%; color: #333; font-size: 14px;"><strong>[listing_id]</strong> - <a href="[listing_url_raw]">[listing_title]</a></td>
								</tr>
								<tr>
									<td style="width: 25%; color: #333; font-size: 14px;"><strong><?php _e( 'Price', 'wpsight' ); ?>:</strong></td>
									<td style="width: 75%; color: #333; font-size: 14px;">[listing_price]</td>
								</tr>
								<tr>
									<td style="width: 25%; color: #333; font-size: 14px;"><strong><?php _e( 'Location', 'wpsight' ); ?>:</strong></td>
									<td style="width: 75%; color: #333; font-size: 14px;">[listing_terms taxonomy="location" link="false"]</td>
								</tr>
								<tr>
									<td style="width: 25%; color: #333; font-size: 14px;"><strong><?php _e( 'Type', 'wpsight' ); ?>:</strong></td>
									<td style="width: 75%; color: #333; font-size: 14px;">[listing_terms taxonomy="listing-type" link="false" sep=", "]</td>
								</tr>
