...
add_action( 'widgets_init', 'wpcasa_register_widget_slider' );
 
function wpcasa_register_widget_slider() {

	if( current_theme_supports( 'FlexSlider' ) )
		register_widget( 'wpCasa_Slider' );

}

class wpCasa_Slider extends WP_Widget {
 
	function __construct() {
		$widget_ops = array( 'description' => __( 'jQuery content slider', 'wpsight' ) );
		parent::__construct( 'wpCasa_Slider', WPSIGHT_NAME . ' ' . __( 'Slider', 'wpsight' ), $widget_ops );
    }
