...
add_action( 'widgets_init', 'wpsight_register_widget_listings_slider' );
 
function wpsight_register_widget_listings_slider() {

	if( current_theme_supports( 'FlexSlider' ) )
		register_widget( 'wpSight_Listings_Slider' );

}

class wpSight_Listings_Slider extends WP_Widget {
 
	function __construct() {
		$widget_ops = array( 'description' => __( 'jQuery listing slider', 'wpsight' ) );
		parent::__construct( 'wpSight_Listings_Slider', ':: ' . WPSIGHT_NAME . ' ' . _x( 'Listings Slider', 'listing widget', 'wpsight' ), $widget_ops );
    }
    ...
    function widget( $args, $instance ) {
		...
		if ( $slider->have_posts() ) {
			...
			<div id="<?php echo wpsight_dashes( $widget_id ); ?>" class="widget widget-slider widget-listings-slider clearfix">
...
?>
		...
		<p>
			...
			<?php do_action( 'wpsight_widget_listings_slider_filter', $this->get_field_id( 'filter' ), $this->get_field_name( 'filter' ), $instance ); ?>		
		</p>
		...
		<p<?php if( $instance['overlay'] == false ) echo ' style="display:none"'; ?>>
		    ...
		    <label for="<?php echo $this->get_field_id( 'details' ); ?>"><?php _e( 'Listing details', 'wpsight' ); ?></label>		
		</p>
		...
		<p<?php if( $instance['overlay'] == false ) echo ' style="display:none"'; ?>>
		    ...
		    <label for="<?php echo $this->get_field_id( 'teaser' ); ?>"><?php _e( 'Listing teaser', 'wpsight' ); ?></label>		
		</p>
